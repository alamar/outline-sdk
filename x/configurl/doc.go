...
Shadowsocks proxy (compatible with Outline's access keys, package [github.com/alamar/outline-sdk/transport/shadowsocks])

	ss://[USERINFO]@[HOST]:[PORT]?prefix=[PREFIX]

SOCKS5 proxy (works with both stream and packet dialers, package [github.com/alamar/outline-sdk/transport/socks5])
...
TLS transport (currently streams only, package [github.com/alamar/outline-sdk/transport/tls])
...
DNS resolution (streams only, package [github.com/alamar/outline-sdk/dns])
...
DNS-over-HTTPS resolution (streams only, package [github.com/alamar/outline-sdk/dns])
...
Stream split transport (streams only, package [github.com/alamar/outline-sdk/transport/split])
...
TLS fragmentation (streams only, package [github.com/alamar/outline-sdk/transport/tlsfrag]).
...
For more details, refer to [github.com/alamar/outline-sdk/transport/tlsfrag].

	tlsfrag:[LENGTH]

Packet reordering (streams only, package [github.com/alamar/outline-sdk/x/disorder])
