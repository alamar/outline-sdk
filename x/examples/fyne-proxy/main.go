...
import (
	...
	"github.com/alamar/outline-sdk/x/config"
	...
	content := container.NewVBox(
		...
		container.NewPadded(
			container.NewVBox(
				...
				addressEntry,
				widget.NewRichTextFromMarkdown("**Transport config** ([format](https://pkg.go.dev/github.com/alamar/outline-sdk/x/configurl#hdr-Config_Format))"),
				configEntry,
